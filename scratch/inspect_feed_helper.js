...
add_action( 'rest_api_init', function () {
  ...
  const snippetPayload = {
    name: 'Antigravity Inspect FeedHelper',
    code: snippetCode,
    active: 1,
    scope: 'global'
  };
  ...
  try {
    ...
    console.log('Querying debug-feed-helper...');
    const queryRes = await apiRequest('/wp-json/dqp/v1/debug-feed-helper', 'GET');
