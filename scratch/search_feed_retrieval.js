...
add_action( 'rest_api_init', function () {
  ...
  const snippetPayload = {
    name: 'Antigravity DB Debug Endpoint 11',
    code: snippetCode,
    active: 1,
    scope: 'global'
  };
  ...
  try {
    console.log('Creating debug snippet 11...');
    ...
    console.log('Querying debug-db-11...');
    const queryRes = await apiRequest('/wp-json/dqp/v1/debug-db-11', 'GET');
